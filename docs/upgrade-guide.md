...
Replace path `GlorifiedKing.wallet::transaction` to `GlorifiedKing\Wallet\Models\Transaction::class`

Replace path `GlorifiedKing.wallet::transfer` to `GlorifiedKing\Wallet\Models\Transfer::class`

Replace path `GlorifiedKing.wallet::wallet` to `GlorifiedKing\Wallet\Models\Wallet::class`
